...
class AppTextTheme extends ThemeExtension<AppTextTheme> {
  ...
  static final AppTextTheme lightTextTheme = AppTextTheme(
    headingLarge: AppFontStyle.headingLarge.copyWith(
      color: AppColors.textHeading,
    ),
    headingMedium: AppFontStyle.headingMedium.copyWith(
      color: AppColors.textHeading,
    ),
    headingSmall: AppFontStyle.headingSmall.copyWith(
      color: AppColors.textHeading,
    ),
    titleLarge: AppFontStyle.titleLarge.copyWith(color: AppColors.textHeading),
    titleMedium: AppFontStyle.titleMedium.copyWith(
      color: AppColors.textHeading,
    ),
    titleSmall: AppFontStyle.titleSmall.copyWith(color: AppColors.textHeading),
    bodyLarge: AppFontStyle.bodyLarge.copyWith(color: AppColors.textBody),
    bodyLargeMedium: AppFontStyle.bodyLargeMedium.copyWith(
      color: AppColors.textBody,
    ),
    bodyLargeSemiBold: AppFontStyle.bodyLargeSemiBold.copyWith(
      color: AppColors.textHeading,
    ),
    bodyMedium: AppFontStyle.bodyMedium.copyWith(color: AppColors.textBody),
    bodyMediumMed: AppFontStyle.bodyMediumMed.copyWith(
      color: AppColors.textBody,
    ),
    bodyMediumSemiBold: AppFontStyle.bodyMediumSemiBold.copyWith(
      color: AppColors.textBody,
    ),
    bodyCaption: AppFontStyle.bodyCaption.copyWith(
      color: AppColors.textCaption,
    ),
    bodyCaptionMedium: AppFontStyle.bodyCaptionMedium.copyWith(
      color: AppColors.textCaption,
    ),
    bodyCaptionSemiBold: AppFontStyle.bodyCaptionSemiBold.copyWith(
      color: AppColors.textCaption,
    ),
    bodySmall: AppFontStyle.bodySmall.copyWith(color: AppColors.textCaption),
    bodySmallMedium: AppFontStyle.bodySmallMedium.copyWith(
      color: AppColors.textCaption,
    ),
    bodySmallSemiBold: AppFontStyle.bodySmallSemiBold.copyWith(
      color: AppColors.textCaption,
    ),
  );
  ...
  static final AppTextTheme darkTextTheme = AppTextTheme(
    ...
    titleLarge: AppFontStyle.titleLarge.copyWith(
      color: AppColors.textOnColorHeading,
    ),
    titleMedium: AppFontStyle.titleMedium.copyWith(
      color: AppColors.textOnColorHeading,
    ),
    titleSmall: AppFontStyle.titleSmall.copyWith(
      color: AppColors.textOnColorHeading,
    ),
    bodyLarge: AppFontStyle.bodyLarge.copyWith(
    ...
    bodyMedium: AppFontStyle.bodyMedium.copyWith(
      color: AppColors.textOnColorBody,
    ),
    bodyMediumMed: AppFontStyle.bodyMediumMed.copyWith(
      color: AppColors.textOnColorBody,
    ...
    bodySmall: AppFontStyle.bodySmall.copyWith(
      color: AppColors.textOnColorCaption,
    ),
    bodySmallMedium: AppFontStyle.bodySmallMedium.copyWith(
      color: AppColors.textOnColorCaption,
